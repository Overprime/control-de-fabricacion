...
function __construct($id,$fechainicio,$horainicio,$horafin,
	...
	$horashombre,$ot,$cencos,$idusuario,$fechaproceso,$procesos,$clasificacion)
{
$this->id = $id;
...
descripciontrabajo,horashombre,ot,cencos,usuario_idusuario,fecha_proceso,procesos_idprocesos,
...
'$this->ot','$this->cencos','$this->idusuario','$this->fechaproceso','$this->procesos','$this->clasificacion');";
$result = $db->query($query);
...
echo "<script>
alert('HA OCURRIDO UN ERROR AL MOMENTO DE INSERTAR EL USUARIO');
window.location='/control-de-fabricacion/pages/creacion-de-reporte';
</script>";
